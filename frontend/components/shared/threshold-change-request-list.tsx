...
import type { StatusTone, ThresholdChangeRequest } from "@/lib/types"
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 text-[14px] leading-5 text-[#E5E7EB]">
              ...
              <span className="font-semibold">{request.currentThreshold}</span>{" "}
              <ArrowRight
...
function ThresholdRow({
  ...
  return (
    <li className="grid grid-cols-[1.3fr_1.1fr_auto] items-center gap-4 px-4 py-4">
      <div className="min-w-0">
      ...
      <div>
        <div className="flex items-center gap-2 text-[15px] text-[#E5E7EB]">
          ...
          <ArrowRight className="size-3.5 text-[#6B7280]" aria-hidden="true" />
          <span className="font-semibold">{request.proposedThreshold}</span>
        </div>
        <div
          className={
